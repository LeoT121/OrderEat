<%-- 
    Document   : agregarinsumo.jsp
    Created on : 22/05/2022, 02:43:07 PM
    ...
    <body>
        <header class="header">
            <div class="header__container">
                ...
                <a class="atras" href="agregarinsumo_platillo.jsp"><i class='bx bx-chevron-left atras'></i></a>
                
                <a class="header__logo">Insumo Nuevo</a>
                ...
                <div class="container">
                    <div class="form-container">
                        <h1 class="title">Agregar Insumo</h1>
                            <form action="Registro_Insumo" method="post" class="form">
                                <div>
                                    <label for="name" class="label">Nombre</label>
                                    <input type="text" id="nombre" name="nombre" placeholder="" class="input input-name" required>

                                    <label for="name" class="label">Unidad de Medida</label>
                                    <select class="select" name="unidad" id="unidad">
                                        <option value="">
                                    ...
                                    <label for="name" class="label">Costo por Unidad de Medidad</label>
                                    <input type="number" id="precio" name="precio" placeholder="" class="input input-name" required>
