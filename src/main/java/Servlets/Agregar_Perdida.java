 ...
 */
public class Agregar_Perdida extends HttpServlet {
                ...
                if(plat != null){ 
                    if(plat.size() > 0){
                        ...
                        if(val.Validar_Agregar_Insumo_Platillo(platillo, cantidad, longitud)){
                            ...
                            if(pla.getCant_mins() >= cant){
                                int estatus = cont.Agregar_Perdida(pla.getCant_mins() - cant, pla.getId_mins());                        
                                if(estatus > 0){        
                                    System.out.println(cant + pla.getPer_mins());
                                    System.out.println(pla.getId_mins());
                                    estatus = cont.Agregar_Perdida2(cant + pla.getPer_mins(), pla.getId_mins());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Agregar_Perdida.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
