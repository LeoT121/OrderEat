...
<body>
    ...
    <header class="header">
        <div class="header__container">
            ...
            <a class="header__logo">Alcaldía </a>
            ...
            <section>
                <div class="container">
                    <div class="form-container">
                        <h1 class="title">Alcaldía</h1>
                            <form method="post" action="SeleccionarDelegacion" class="form">
                                <div>
                                ...
                                <input type="submit" value="Cotinuar" class="primary-button login-button">
                            </form>
                    </div>
                </div>
            </section>
