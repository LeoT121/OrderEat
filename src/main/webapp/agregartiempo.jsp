...
<body>
    <header class="header">
        <div class="header__container">
            ...
            <a class="header__logo">Agregar Período</a>
            ...
            <section>
                <div class="container">
                    <div class="form-container">
                        <h1 class="title">Período</h1>
                        <br>
                            <form method="post" action="Agregar_Tiempo" class="form">
                                <div>
                                    <label for="name" class="label">Nombre del Período</label>
                                    <input type="text"  placeholder="" id="tiempo" name="tiempo" class="input input-name" required>
